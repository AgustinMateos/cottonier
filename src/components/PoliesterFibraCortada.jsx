        ...
        <div className="min-h-[50vh] bg-[#ECECEC]">
            ...
            <div>
                <div className="w-full flex items-center flex-col">
                    <h4 className="w-[80%] h-[5vh] text-[20px]">Título Ingles</h4>
                    <div className="w-full h-auto">
                        <div className="w-full">
                        <ul className="flex flex-row items-center text-center justify-evenly">
        ...
        <li key={title}>
            ...
            >
                {title}
                        ...
                        <div className="flex flex-col items-center justify-center w-full h-[57vh]">
                            <div className="flex">
